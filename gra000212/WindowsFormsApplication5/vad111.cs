        ...
        {
            {
                ...
                for (float x = 0; x < 15; x += stepX)
                {
                    ...
                    Pen p = new Pen(randomColor, 0.015F);
                    y = (float)Math.Sin(x);
                    y22 = (float)Math.Sin(10 * x) + (float) Math.Cos(x) ;



                    
                    y3 = (float)Math.Sin(x+ y22) * y22 * y;
                    ...
                    Pen p3 = new Pen(Color.Green, 0.015F);
                    gr.DrawLine(p3, -stepX, lastY3, 0, y3);
                    lastY3 = y3;
